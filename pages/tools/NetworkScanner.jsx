                  ...
                  <div className="space-y-4">
                    {scanResults.openPorts.length === 0 ? (
                      <div className="flex flex-col items-center justify-center h-40 text-center">
                        ...
                        <p className="font-medium text-green-600 dark:text-green-400">No open ports found!</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                          Your network appears to be secure
                        </p>
                      </div>
                        ...
                        {scanResults.openPorts.map((port, index) => (
                          ...
                          >
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span
                                className={`px-2 py-0.5 text-xs font-medium rounded-full ${getStatusColor(port.status)}`}
                              >
                                {port.status}
                              </span>
                            </div>
                            <p className="text-sm text-gray-600 dark:text-gray-400">{port.service}</p>
                          </div>
                        ))}
                      </div>
                    )}
