...
export default function ToolsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight">Security Tools</h2>
        <p className="text-muted-foreground">Access all our security tools to protect your digital assets.</p>
      </div>
